...
input.addEventListener('keyup', () => {
    ...
    search_results.addEventListener("click", (event) => {
        ...
        music.src = `./audio/${targetId}.mp3`;
        poster_master_play.src =`/img/${targetId}.jpg`
        title.innerHTML = ``
        music.play();
        masterPlay.classList.remove('bi-play');
        masterPlay.classList.add('bi-pause');

        download_music.href = `../audio/${targetId}.mp3`
...
Array.from(document.getElementsByClassName('playMyList')).forEach((e) => {
    e.addEventListener('click', (element) => {
        ...
        music.src = `./audio/${idx}.mp3`;
        poster_master_play.src =`/img/${idx}.jpg`
        title.innerHTML = ``
        music.play();
        masterPlay.classList.remove('bi-play');
        masterPlay.classList.add('bi-pause');

        download_music.href = `../audio/${idx}.mp3`
...
let play_faded = document.getElementById('play-faded');
play_faded.addEventListener('click', () => {
    music.play();
